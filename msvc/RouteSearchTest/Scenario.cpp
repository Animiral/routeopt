...
Scenario3::Scenario3()
	:
	a_id(graph.AddNode({0, 0, 100})),
	b_id(graph.AddNode({10, -10, 110})),
	c_id(graph.AddNode({20, 10, 100})),
	d_id(graph.AddNode({30, 0, 110})),
	ab_id(graph.AddEdge(a_id, b_id, {20000, 5.f, .5f, 100.f})),
	ac_id(graph.AddEdge(a_id, c_id, {20000, 30.f, .5f, 100.f})),
	bc_id(graph.AddEdge(b_id, c_id, {20000, 5.f, .5f, 100.f})),
	bd_id(graph.AddEdge(b_id, d_id, {20000, 20.f, .5f, 100.f})),
	cd_id(graph.AddEdge(c_id, d_id, {20000, 5.f, .5f, 100.f})),
