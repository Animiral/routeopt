...
\begin{abstract}
\noindent An analysis of a path search algorithm on an airspace graph with restrictions. This problem is derived from practical use cases of flight planning.
\end{abstract}
}
...
The first step towards analyzing the algorithm is an implementation using only the bare-bones necessary features: an A* search and one type of constraints.
